---
title: Singapore Revamps OT Security Framework, Prioritizing Secure Information Flow & Boosting Cyber Resilience - ZDNet Insight
date: 2024-10-20T18:46:42.636Z
updated: 2024-10-26T16:28:29.685Z
tags:
  - edge-computing
categories:
  - tech
thumbnail: https://www.zdnet.com/a/img/resize/d49da34f46ed745227d2d374ae349360fc81d5aa/2024/08/20/76fc7938-84d3-4f48-bfd1-44db017c2774/security-network-yuichiro-chino082024.jpg?width=170&height=128&fit=crop&auto=webp
---

## Singapore Revamps OT Security Framework, Prioritizing Secure Information Flow & Boosting Cyber Resilience - ZDNet Insight

![abstract graphic of padlock amid circuitry board](https://www.zdnet.com/a/img/resize/ed1e9f37dd8fcaa671aba3964ea410a055357a4b/2024/08/20/76fc7938-84d3-4f48-bfd1-44db017c2774/security-network-yuichiro-chino082024.jpg?auto=webp&width=1280)

Yuichiro Chino/Getty Images

Singapore has updated its operational technology (OT) [cybersecurity](https://www.zdnet.com/article/cybersecurity-101-everything-on-how-to-protect-your-privacy-and-stay-safe-online/) blueprint to focus on enhanced data sharing, policies and processes, and skills training. According to the Cyber Security Agency (CSA), it has also been expanded to include non-critical infrastructures. 
...
First released in 2019, the [OT security masterplan](https://www.zdnet.com/article/singapore-tweaks-cybersecurity-strategy-with-ot-emphasis/) needed an update to keep up with a threat landscape that has evolved in scale, sophistication, and frequency, CSA said. As digital tools and connectivity are now widely adopted, cyber resilience is essential for non-CII ([critical information infrastructures](https://www.zdnet.com/article/singapore-wants-all-critical-infrastructures-to-be-ready-for-cyber-threats/)) sectors, and all organizations must think about "secure by deployment" principles. 
...
It added that the [updated masterplan](https://www.csa.gov.sg/News-Events/Press-Releases/2024/singapore-updates-operational-technology-cybersecurity-masterplan) aims to address [threats that target OT systems](https://www.zdnet.com/article/industrial-networks-need-better-security-as-attacks-gain-scale/) amid geopolitical and technological shifts, including a significant spike in hacktivism attacks targeting OT assets of "non-aligned countries" and the integration of technologies, such as edge computing and the Internet of Things (IoT), which have increased the attack surface for OT systems.

**Also: [As use of IoT devices grows, so do the associated security risks](https://www.zdnet.com/article/as-use-of-iot-devices-grows-so-do-the-associated-security-risks/)**
...
In addition, it is developing a data-driven model to enhance visibility across the [supply chain](https://www.zdnet.com/article/apac-firms-need-to-build-trust-brace-for-more-third-party-attacks/) that impacts both CII and non-CII sectors. The aim here is to provide accurate and up-to-date data and analysis of vendor risks, CSA said. 

"Cyber risks are widespread and impact CII and other important OT systems due to [dependency or supply chain risks](https://www.zdnet.com/article/growing-reliance-on-third-party-suppliers-signals-increasing-security-risks/)," it said. A data platform will improve CSA's visibility of cybersecurity risks OT infrastructures face and monitor these risks. The regulator can then issue alerts and advisories to guide these sectors on the necessary remediation or mitigating controls, CSA explained. 
...
**Also: [The biggest challenge with increased cybersecurity attacks, according to analysts](https://www.zdnet.com/article/the-biggest-challenge-with-increased-cybersecurity-attacks-according-to-analysts/)**

"The adoption of the [secure-by-deployment principles](https://www.zdnet.com/article/singapore-urges-nation-to-adopt-security-by-design-mindset/) is crucial in safeguarding the entire lifecycle management of OT systems, from product design, deployment, and maintenance involving multiple stakeholders from original equipment manufacturers (OEMs), systems integrators to asset owners," CSA said. 
...
"From the 2010 Stuxnet incident, the [EKANS](https://www.zdnet.com/article/this-is-how-ekans-ransomware-is-targeting-industrial-control-systems/) attack on Honda in 2020, to the discovery of the [Pipedream](https://www.cisa.gov/sites/default/files/publications/AA22-103A%5FAPT%5FCyber%5FTools%5FTargeting%5FICS%5FSCADA%5FDevices.pdf) malware toolkit in 2022, it is clear that threats to our OT environment are real and growing in sophistication and intent," said David Koh, CSA's chief executive, and Singapore's cybersecurity commissioner. "Successful compromise of \[OT\] systems, which the delivery of essential services depends on, will jeopardize our national security, public and environmental safety, the economy, and our way of life. The stakes are too high to ignore, and we must push the envelope and do more."
