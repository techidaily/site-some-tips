---
title: "Unpacking the Numbers: Understanding Why Nearly All Tech Employers Insist on Degrees From Candidates"
...
## Unpacking the Numbers: Understanding Why Nearly All Tech Employers Insist on Degrees From Candidates

![university-west-chester-university-photo-by-joe-mckendrick](https://www.zdnet.com/a/img/resize/68a44dffaed4c5ab36fabf5b1d4729f208f71568/2022/07/22/da54f3d8-f266-4e45-a287-3717026237eb/university-west-chester-university-photo-by-joe-mckendrick.jpg?auto=webp&precrop=1512,1374,x0,y237&width=1280)
...
[The best Python courses Here are some of the top sites where you can learn to code this language.  Read now](https://www.zdnet.com/article/best-python-course/)
...
Other voices are pushing back against college degree requirements in the technology field -- even within the upper echelons of higher education. [David Nuñez](https://davidnunez.com/), director of technology and digital strategy at the [MIT Museum](https://mitmuseum.mit.edu/), indicates that he has reviewed thousands of résumés for technical roles. But the "harsh truth," he recently shared in a series of tweets, is, "a college degree, certifications, and laundry list of technical skills barely matter to somebody like me."
...
When asked why a degree is required, two in five employers (40%) in the Cengage study believe "candidates with a college degree are more equipped for the role." Three in five employers (62%) require a degree for all entry-level positions. 
...
Tellingly, 47% think it is difficult to measure the meaningfulness of a certification or credentials in potential employees' lines of work. At least 16% say that it is because they are not familiar with the certifications/credentials mentioned. Another 36% say that it is because they are not sure which certifications/credentials have credibility and which don't. Then there are 40% say that it is because they are hiring candidates in a field with which they are not familiar.

**Also: [As cloud adoption grows, so do tech leadership roles](https://www.zdnet.com/article/as-cloud-adoption-grows-so-do-technology-professionals-business-leadership-roles/)**

Along with certification and accreditation programs, many skills can be learned from the internet at little to no cost. "Technical interviews emphasize algorithms and problem solving," Nuñez says. "Computer science courses at a university can give you a structured way to learn the foundations needed to pass those interviews. However, resources to learn these concepts are available online, for free -- for example, [MITx](https://mitxonline.mit.edu/). The interview processes at FAANG companies are so well known that you can buy books about them and study practice questions."
