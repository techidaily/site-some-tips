---
title: "Step-by-Step Guide: Changing Release Channels on a Chromebook - Insights From ZDNet"
date: 2024-09-19 14:25:42
...
## Step-by-Step Guide: Changing Release Channels on a Chromebook - Insights From ZDNet
...
The ChromeOS Settings window gives you access to the About ChromeOS section.

Image: Jack Wallen

In the About ChromeOS section (**Figure 2**), click Additional details.

The About ChromeOS section in the Settings app.
...
Changing channels in ChromeOS is quite simple.

Image: Jack Wallen

In the popup window (**Figure 4**), select the channel you want to use.

The ChromeOS channel selector popup allows you to select which channel you want to switch to.

Image: Jack Wallen

In the resulting window (**Figure 5**), click Change channel and Powerwash.

Don't continue unless you've backed up any files saved to local storage.
