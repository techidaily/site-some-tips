---
title: "Bluehost Evaluation by ZDNet: Outstanding Hosting Services, Intuitive Dashboard, and Trustworthy Assistance"
date: 2024-12-19T20:25:45.030Z
updated: 2024-12-21T00:03:52.754Z
tags:
  - cloud
categories:
  - tech
...
## Bluehost Evaluation by ZDNet: Outstanding Hosting Services, Intuitive Dashboard, and Trustworthy Assistance

![Blue Host on a MacBook screen](https://www.zdnet.com/a/img/resize/3f6e7a27385712e8d4fe70eab2872fd21a22b7ed/2024/04/09/a6d640aa-c262-4fb3-ad39-fb3167f96463/20240409-124438.jpg?auto=webp&width=1280)

Kerry Wan/ZDNET

It seems like there are an almost unlimited number of web hosting providers who will serve your website for a monthly fee. In our tested list of the [best web hosting services](https://www.zdnet.com/article/best-web-hosting/), we spotlighted providers that offer a wide range of plans. When doing a full review of a single hosting provider, I set up the most basic account possible and run the service through a barrage of tests. In this article, I'll dive into [Bluehost's](https://bluehost.sjv.io/c/159047/795082/11352?&sharedid=zdnet&partnerpropertyid=1980086&u=https%3A%2F%2Fwww.bluehost.com%2F&subId1=zd-%5F%5FCOM%5FCLICK%5FID%5F%5F-dtp) offerings based on my hands-on testing. 

**Also: [WP Engine review: A solid managed-hosting provider for WordPress](https://www.zdnet.com/article/wp-engine-review/)**
...
* [Online store hosting](https://bluehost.sjv.io/c/159047/795082/11352?&sharedid=zdnet&partnerpropertyid=1980086&u=https%3A%2F%2Fwww.bluehost.com%2Fpricing&subId1=zd-%5F%5FCOM%5FCLICK%5FID%5F%5F-dtp) starting at $9.95 per month
* [Virtual private server (VPS) hosting](https://bluehost.sjv.io/c/159047/795082/11352?&sharedid=zdnet&partnerpropertyid=1980086&u=https%3A%2F%2Fwww.bluehost.com%2Fpricing&subId1=zd-%5F%5FCOM%5FCLICK%5FID%5F%5F-dtp) starting at $31.99 per month
* [Dedicated server hosting](https://bluehost.sjv.io/c/159047/795082/11352?&sharedid=zdnet&partnerpropertyid=1980086&u=https%3A%2F%2Fwww.bluehost.com%2Fpricing&subId1=zd-%5F%5FCOM%5FCLICK%5FID%5F%5F-dtp) starting at $91.98 per month
* [Cloud hosting](https://bluehost.sjv.io/c/159047/795082/11352?&sharedid=zdnet&partnerpropertyid=1980086&u=https%3A%2F%2Fwww.bluehost.com%2Fpricing&subId1=zd-%5F%5FCOM%5FCLICK%5FID%5F%5F-dtp) starting at $29.99 per month
...
Regular, non-incognito window in Chrome
...
It is weird, though, because if you sign up for just a year, you're paying less per month for that first year. But then your price will jump by more than quadruple what you paid when you signed up. I talked a lot about _lock-in_ and _switching costs_ in my [How to create a website: The step-by-step guide](https://www.zdnet.com/article/how-to-build-a-website/) overview. Read it, because Bluehost (and many other hosting providers) have business models that count on the switching costs being so painful that you'll suck up a huge upcharge simply to avoid moving your site.
...
**Also: [The best web hosting services of 2024: Expert tested](https://www.zdnet.com/article/best-web-hosting/)**
...
Before we move into the details, let's spend a moment talking about what a base plan really is. All websites are not created equal. While you might be able to pay under three bucks a month to run your website, I pay about a hundred bucks each month to run [my small fleet of sites](https://www.zdnet.com/article/anatomy-of-a-wordpress-site/). 
...
**Also: [The best cheap web hosting services](https://www.zdnet.com/article/best-cheap-web-hosting/)**
...
Bluehost offers a number of pretty solid features in their Basic plan. The base plan includes 10GB website space, one website, and a basic SSL certificate, and what they describe as unmetered bandwidth. This [Help Page](https://bluehost.sjv.io/c/159047/795082/11352?&sharedid=zdnet&partnerpropertyid=1980086&u=https%3A%2F%2Fwww.bluehost.com%2Fhelp%2Farticle%2Fshared-hosting-prices%23shared-hosting&subId1=zd-%5F%5FCOM%5FCLICK%5FID%5F%5F-dtp) provides more details:

Screenshot by David Gewirtz/ZDNET

Be careful, though. In practice, if you push your account near the limits, or use an excessive amount of bandwidth, it's likely that the service will throttle you back. [Bluehost was one of the earliest providers](https://en.wikipedia.org/wiki/Bluehost) to institute server throttling when "unlimited" resource usage got to be too much. 
...
Partial list of installed plugins
...
The first of these is [multifactor authentication](https://www.zdnet.com/article/better-than-the-best-password-how-to-use-2fa-to-improve-your-security/) (MFA). It's way too easy for hackers to just bang away at a website's login screen and brute-force a password. In the past, many of my sites have been pounded on by some hacker or another, but because I have some relatively strong protections in place, the bad actor hasn't been able to get in. 

**Also: [Saving hours of work with AI: How ChatGPT became my virtual assistant for a data project](https://www.zdnet.com/article/saving-hours-of-work-with-ai-how-chatgpt-became-my-virtual-assistant-for-a-data-project/)**
...
Here are my findings (using the [Health Check & Troubleshooting plugin](https://wordpress.org/plugins/health-check/)), as of the day I tested, for Bluehost's Basic plan: 

| **Component** | **Version Provided** | **Current Version** | **How Old** |
| ------------- | -------------------- | ------------------- | ----------- |
| PHP           | 8.3.4                | 8.3.4               | Current     |
| MySQL         | 5.7.23-23            | 5.7.44              | 68 months   |
| cURL          | 8.7.1                | 8.7.1               | Current     |
| OpenSSL       | 1.1.1w               | 3.2.1               | Unsupported |
...
SSL is far worse. This is the security environment that provides encrypted communications to your website. It's what's indicated by that little lock in your browser's address bar. Bluehost is running an [unsupported and obsolete version of OpenSSL](https://www.openssl.org/blog/blog/2023/09/11/eol-111/index.html). This is not new news. It's now seven months since the entire OpenSSL 1.1.1 track has been end-of-lifed. 

Bluehost says that it's not really a problem, because they [backport](https://docs.cpanel.net/knowledge-base/security/pci-compliance-and-software-versions/) security code into their implementation. Brent Lundell, senior director of hosting infrastructure at Bluehost told me this:
...
**Also: [I used ChatGPT to write the same routine in 12 top programming languages. Here's how it did](https://www.zdnet.com/article/i-used-chatgpt-to-write-the-same-routine-in-12-top-programming-languages-heres-how-it-did/)**
...
First, I ran two [Pingdom Tools](https://tools.pingdom.com/) tests, one hitting the site from San Francisco and the second from Germany. Here's the San Francisco test rating: 
