---
title: Russian-Ukraine Conflict and Its Dire Consequences for Information Technology Businesses
date: 2024-12-25T16:31:43.486Z
updated: 2024-12-27T17:09:29.341Z
tags:
  - cloud
categories:
  - tech
...
## Russian-Ukraine Conflict and Its Dire Consequences for Information Technology Businesses

![Kiev, Ukraine](https://www.zdnet.com/a/img/resize/ed687cb6ee86744ca392008571086b1e83c025dd/2022/02/25/fec61d01-b6f7-40e8-9fa3-a4c030d189e4/getty-kiev-ukraine-high-angle-view-of-illuminated-city-buildings-at-night.jpg?auto=webp&width=1280)

A view of Kiev, Ukraine.

Getty Images

**Editorial Note:** _In response to Russia's "unprovoked attack on Ukraine" on February 23, the Cybersecurity & Infrastructure Security Agency (CISA) [published an updated set of cybersecurity recommendations](https://www.cisa.gov/shields-up) for organizations._

In the five years since I first explored the potential impact of a Digital Cold War on the IT industry, tensions with Russia have gotten worse, especially following a series of cyberattacks on systems in the United States. These include Russia's involvement in the [SolarWinds breach](https://www.zdnet.com/article/us-government-formally-blames-russia-for-solarwinds-hack/), as well as its interference with the 2016 US presidential elections via [attacks on the Democratic National Committee infrastructure](https://www.cbsnews.com/news/report-on-russian-hacking-released-by-intelligence-community/) and the [purchasing of tens of millions of ads on Facebook](https://www.cbsnews.com/news/facebook-10m-people-saw-russian-linked-ads-2016-election/) in an attempt to sow discontent among US voters.
...
Under the pretext of ["Peacekeeping operations,"](https://www.axios.com/putin-recognize-donetsk-luhansk-republics-ukraine-166bbe54-2d6a-446a-87bd-e9e63cf21ca9.html) Russia has now initiated a [full-scale invasion of Ukraine](https://www.cnn.com/2022/02/23/europe/russia-ukraine-putin-military-operation-donbas-intl-hnk/index.html). Presumably, Russia also has been responsible for recent [cyberattacks on Ukrainian banks.](https://apnews.com/article/russia-ukraine-technology-business-europe-russia-e791990f60841b599f664c34f58403de)

In response, the United States, NATO nations, and allied countries [have imposed numerous economic sanctions on Russia](https://www.aljazeera.com/news/2022/2/23/what-sanctions-have-been-imposed-on-russia), including blocking its two state-owned banks from debt trading on US and European markets and freezing their assets under US jurisdictions, as well as freezing the assets of the country's wealthiest citizens. Germany has [halted its plans](https://www.cnn.com/2022/02/22/business/nord-stream-2-germany-russia/index.html) on Russia's Nord Stream 2 Gas Pipeline. Further wide-ranging sanctions are expected as Russia continues its assault on Ukraine.

On February the 23rd, President Biden [condemned the military action](https://www.whitehouse.gov/briefing-room/statements-releases/2022/02/23/statement-by-president-biden-on-russias-unprovoked-and-unjustified-attack-on-ukraine/) and said, "President Putin has chosen a premeditated war that will bring a catastrophic loss of life and human suffering. Russia alone is responsible for the death and destruction this attack will bring, and the United States and its Allies and partners will respond in a united and decisive way. The world will hold Russia accountable."
...
UK-incorporated [Kaspersky Lab](http://en.wikipedia.org/wiki/Kaspersky%5FLab), for example, is a major and well-established player in the antivirus/antimalware space. It maintains its international headquarters and has substantial research and development capabilities in Russia, even though its [primary R&D center was moved to Israel in 2017](https://www.kaspersky.com/about/press-releases/2017%5Fkaspersky-lab-opens-new-future-tech-lab-in-israel).

It's also thought that [Eugene Kaspersky](http://en.wikipedia.org/wiki/Eugene%5FKaspersky), the company's founder, [has strong personal ties](http://www.wired.com/dangerroom/2012/07/ff%5Fkaspersky/all/) to the Putin-controlled government. Kaspersky [has repeatedly denied](http://eugene.kaspersky.com/2012/07/25/what-wired-is-not-telling-you-a-response-to-noah-shachtmans-article-in-wired-magazine/) these allegations, but questions about the man and his company remain and will be further scrutinized, particularly as the conflict develops.

In the past, evidence emerged that Kaspersky's software was involved in compromising [the security of a contract employee of the United States National Security Agency in 2015.](https://www.cbsnews.com/news/russian-based-kaspersky-software-believed-to-been-used-to-take-classified-nsa-data/) Kaspersky Lab insists that, to the contrary, the [evidence supporting this has not been properly established](https://usa.kaspersky.com/blog/kaspersky-in-the-shitstorm/13007/) and has produced [an internal audit of the findings](https://www.kaspersky.com/blog/internal-investigation-preliminary-results/19894/).

It's also important to note that companies with no evidence of any wrongdoing are suffering guilt by association.

[NGINX Inc](http://en.wikipedia.org/wiki/NGINX,%5FInc.) is the support and consulting arm of an [open source reverse proxy web server project](http://en.wikipedia.org/wiki/Nginx) that is very popular with some of the most high-volume internet services on the planet. The company is of Russian origin but was [sold to F5 Networks in 2019](https://www.f5.com/company/news/press-releases/f5-acquires-nginx-to-bridge-netops-devops). The founder of the company, [Igor Sysoev,](https://en.wikipedia.org/wiki/Igor%5FSysoev) announced his departure in January of this year.

[Parallels, Inc.](http://en.wikipedia.org/wiki/Parallels,%5FInc.), which Corel acquired[in 2018](https://www.parallels.com/blogs/parallels-joins-the-corel-family/), focuses extensively on virtualization technology. Their [Parallels Desktop](https://www.parallels.com/pd/general/?gclid=Cj0KCQiAmKiQBhClARIsAKtSj-kyGdpRiAtIpGuLqsyLC7XwUkV26ipa6JXloTO%5FQt6eeQR5829i6NMaAiWxEALw%5FwcB) is one of the most popular solutions for Windows virtualization on the Mac. Historically, their primary development labs were in Moscow and Novosibirsk, Russia. The company was founded by [Serguei Beloussov](https://www.linkedin.com/in/sbeloussov), who was born in the former Soviet Union and later emigrated to Singapore. Two of their products, [Virtuozzo](http://www.virtuozzo.com) and [Plesk](https://www.plesk.com), were spun off as their own companies in 2017\. Parallels' [Odin](https://www.ingrammicrocloud.com/cz/en/blogs/announcing-odin-automation-essentials/), a complex management stack for billing and provisioning automation used by service providers and private clouds running on VMware's virtual infrastructure stack and Microsoft's Azure, [was sold to Ingram Micro in 2015.](https://www.businesswire.com/news/home/20151202005470/en/Parallels-Holdings-Limited-Announces-the-Sale-of-its-Odin-Service-Automation-Platform-to-Ingram-Micro)
...
World governments do not need to levy [Iran-style isolationist sanctions](http://en.wikipedia.org/wiki/U.S.%5Fsanctions%5Fagainst%5FIran) against Russia for a snowball effect to start within US corporations that use Russian software or services.
...
Will Russian software and services become the first victim in a Digital War? _Talk Back and Let Me Know._
