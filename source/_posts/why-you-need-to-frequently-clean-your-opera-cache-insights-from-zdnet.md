...
I've been using Opera as my default browser for some time now. The main reason I do so is that [Opera has perfected tab management](https://www.zdnet.com/home-and-office/work-life/opera-workspaces-is-tab-management-perfection/). 
...
**Also:** [**How to clear your iPhone cache (and why you should)**](https://www.zdnet.com/article/how-to-clear-cache-on-iphone-and-why-you-should/)
...
The only thing you'll need is the Opera browser installed on your desktop or laptop. I'll be demonstrating with version 93.0.4585.37 running on [Pop!\_OS](https://www.zdnet.com/article/pop-os-might-have-a-complicated-name-but-it-makes-using-linux-so-easy/), but the process is the same regardless of which operating system you use.
