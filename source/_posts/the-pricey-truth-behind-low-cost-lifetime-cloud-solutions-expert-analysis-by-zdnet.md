---
title: "The Pricey Truth Behind Low-Cost Lifetime Cloud Solutions: Expert Analysis by ZDNet"
date: 2024-12-30T01:31:38.436Z
updated: 2025-01-06T03:26:21.050Z
tags:
  - cloud
categories:
  - tech
...
## The Pricey Truth Behind Low-Cost Lifetime Cloud Solutions: Expert Analysis by ZDNet

![cloud-stroage-gettyimages-1324448597](https://www.zdnet.com/a/img/resize/2495658912721ae58bd1f7e6ae0d016dd014426c/2023/09/25/fae66a88-0814-4b91-99de-404fa57c77dc/cloud-stroage-gettyimages-1324448597.jpg?auto=webp&width=1280)
...
For example, I use [Apple's 2TB iCloud plan at $10/month](https://www.zdnet.com/article/apple-adds-6tb-and-12tb-icloud-storage-tiers-priced-at-30-and-60-a-month/). I also use Google Drive for cloud storage. In order to house my company's 57TB of data, I had to sign up for [Google's Enterprise plan](https://www.zdnet.com/article/why-my-two-person-company-bought-a-google-workspace-enterprise-plan/). For now, that costs $100 per month. Google has said that [pricing will go up](https://www.zdnet.com/article/the-other-shoe-finally-dropped-on-my-google-enterprise-cloud-storage-plan/), but they haven't published what the increase will be for Enterprise plan customers. It's not a nice feeling to know you're going to get charged more, but to have no idea how much more.

**Also: [Need more storage? How to quickly set up a Synology DS223j NAS](https://www.zdnet.com/article/need-more-storage-how-to-quickly-set-up-a-synology-ds223j-nas/)**
...
It's not a bad deal, especially since the regular prices published on the [Degoo site](https://degoo.com/) are considerably more expensive. 

Screenshot by David Gewirtz/ZDNET

So who is Degoo? The company's [About page](https://degoo.com/about) says it's located in Sweden. Seriously. That's about it. There's virtually no content on the About page about Degoo. Disturbingly, a Google search for Degoo shows this: 
...
**Also: [The best NAS devices: Store and share more, for less](https://www.zdnet.com/article/best-network-attached-storage/)**

The second interesting indicator is [a Google profile](https://cloud.google.com/customers/degoo) on the company. Google did a case study on the company, although it's not clear when the write-up was published. Interestingly, this tells us that Degoo is using the Google Cloud for storage and it has nine million users. 

So, on one hand, the company does seem to be real despite the "Fake Storage" search result. But here's a simple bit of math: [Google charges](https://cloud.google.com/storage/pricing#europe) $0.020 to $0.023 per month, per year. A terabyte is 1,000 gigabytes. Multiplying 1,000 gigabytes times 10 (for 10GB storage) times $0.20, we find that Google's price for 10TB is $2,000\. 

**Also: [How to easily install a cloud service at home in an hour or less](https://www.zdnet.com/article/how-to-easily-install-a-cloud-service-at-home-in-an-hour-or-less/)**

Clearly, $99 for 10TB is not sustainable. My bet is that storage vendors offering unlimited storage are doing the same calculus that health clubs do when they sell you a membership. It's betting that its customers won't fully utilize the resources they're paying for. 
...
My initial web search didn't turn up a Fake Storage company for these folks, but there was a [Reddit thread](https://www.reddit.com/r/DataHoarder/comments/ujrr02/what%5Fdo%5Fyou%5Fguys%5Fthink%5Fof%5Fprism%5Fdrive/) where [a participant who apparently lives near the posted address for the company](https://www.reddit.com/r/DataHoarder/comments/ujrr02/what%5Fdo%5Fyou%5Fguys%5Fthink%5Fof%5Fprism%5Fdrive/ihmuokv/?utm%5Fsource=share&utm%5Fmedium=web3x&utm%5Fname=web3xcss&utm%5Fterm=1&utm%5Fcontent=share%5Fbutton) in Santa Ana, CA says it's a virtual office, with no permanent tenants. That's essentially hearsay, but it's worrisome. 
...
Despite appearing to be either a New York or London company, the company seems to be from Helsinki, Finland because the Governing Law clause of the site's terms and conditions says, "Any dispute related to the use of these pages will be settled by the district court in Helsinki, Finland." This tracks with a [vaguely ranty Medium post](https://nhalstead.medium.com/scam-polar-backup-cloud-storage-93656733b780) claiming "Polar Backup is a scam," by a user named Noah Halstead. 

**Also: [The best travel VPNs: Expert tested and reviewed](https://www.zdnet.com/article/best-travel-vpn/)**

The domain for [polarbackup.com](http://polarbackup.com) is registered via Amazon, which may imply Polar Backup is using Amazon's storage infrastructure. 

This is purely speculative, but Amazon offers a low-price, cold-storage (meaning, rarely accessed) [service called Glacier](https://buy.geni.us/Proxy.ashx?TSID=368250&GR%5FURL=https%3A%2F%2Fdocs.aws.amazon.com%2Famazonglacier%2Flatest%2Fdev%2Fintroduction.html%3Ftag%3Dzd-buy-button-20%26ascsubtag%3D%5F%5FCOM%5FCLICK%5FID%5F%5F%7C881fc4d3-0f80-44d7-a9cf-2afc37ea0e60%7Cdtp&dtb=1). It would stand to reason that a storage service built atop AWS Glacier might be called Polar Backup. Amazon's S3 Glacier tier charges very low prices for uploads into storage. It's considerably more expensive to retrieve. That said, Polar might be able to support the unlimited business model if most users don't try to do many retrieves. 

Another clue that Polar might be using AWS for infrastructure is the mention of AWS compliance on the [company's GDPR page](https://www.notion.so/Why-that-cheap-lifetime-cloud-storage-offer-might-cost-you-more-than-you-think-64b372412b93442596b0b2feaa1e5856?pvs=21). Polar Backup is listed in [Crunchbase](https://www.crunchbase.com/organization/polarbackup), but with no details other than it may have an estimated 11-50 employees. 
...
**Also:** [**The best TV antennas: Top picks for signal strength**](https://www.zdnet.com/home-and-office/home-entertainment/best-tv-antenna/)

**Terrible reviews:** All of these vendors have many terrible, terrible customer reviews. That's not a good sign. 
...
Given this disturbing scenario, is it worth taking the chance with all your data? That's what you have to decide. Is it worth it? 
...
[The best network-attached storage devices: Store more for less](https://www.zdnet.com/article/best-network-attached-storage/ "The best network-attached storage devices: Store more for less")

[How to easily manage your Google Workspace storage](https://www.zdnet.com/article/how-to-easily-manage-your-google-workspace-storage/ "How to easily manage your Google Workspace storage")

[Why that cheap 'lifetime cloud storage' deal might cost more than you bargained for](https://www.zdnet.com/article/why-that-cheap-lifetime-cloud-storage-deal-might-cost-more-than-you-bargained-for/ "Why that cheap 'lifetime cloud storage' deal might cost more than you bargained for")

[Not buying a new iPhone? This flash drive will give your old one a new lease on life](https://www.zdnet.com/article/not-buying-a-new-iphone-this-flash-drive-will-give-your-old-one-a-new-lease-of-life/ "Not buying a new iPhone? This flash drive will give your old one a new lease on life")
