---
title: Sustainability Is Increasingly Becoming an Integral Part of Soil Mechanics, with Research Focusing on Minimizing Environmental Impacts While Ensuring Construction Safety and Durability.
date: 2024-12-08T16:21:36.024Z
updated: 2024-12-12T16:54:56.007Z
tags:
  - cloud
categories:
  - tech
thumbnail: https://www.zdnet.com/topic/cloud/    https://www.zdnet.com/a/img/resize/184a26cb457e61c1189075ca6c005feb68b9e0e7/2024/02/12/4c96e0ae-3b0d-4945-b3b1-c58f8588a732/ibm-linux-main-screenshot-2024-02-12-111312.jpg?width=170&height=96&fit=crop&auto=webp
---

## Sustainability Is Increasingly Becoming an Integral Part of Soil Mechanics, with Research Focusing on Minimizing Environmental Impacts While Ensuring Construction Safety and Durability.

![IBM LinuxONE 4 Express](https://www.zdnet.com/a/img/resize/5e94b354199eab82bedd11552c99d85854b10476/2024/02/11/68e9d3a9-4a3d-4dd0-bb49-f94af8380cad/linuxone4-express.jpg?auto=webp&width=1280)

IBM

When you think of mainframes, you may recall those days of hulking machines with blinking lights and 9-track tape drives spinning. How things have changed. These days, Big Blue's latest [IBM LinuxONE 4 Express](https://www.ibm.com/products/linuxone-4), a pre-configured rack mount system, would pass without remark in most small to medium-sized businesses (SMBs).

Until they started using it. Then, it would be a different story.

**Also: [A look back at 40 Years of GNU and the Free Software Foundation](https://www.zdnet.com/article/40-years-of-gnu-and-the-free-software-foundation/)**

The IBM LinuxONE 4 Express, the newest member of the Rockhopper mainframe family, comes with up to a maximum of 16 [Integrated Facility for Linux (IFLs)](https://www.ibm.com/products/integrated-facility-for-linux). These Linux-only system boards are powered by a 4.6GHz IBM 8-core Telum processor. This 7nm architecture chip can support as much as 864GB of memory. Storage? It's a rack mount, so you can add pretty much any storage you like. 

The Telum chip also includes an AI coprocessor. The goal is to enable you to use AI to deal with transactions in close to real-time. For example, IBM claims you can use the Telum chip to catch [financial transaction fraud before it can be processed](https://newsroom.ibm.com/2021-08-23-IBM-Unveils-On-Chip-Accelerated-Artificial-Intelligence-Processor). Color me impressed. 

The new mainframe is also designed -- when used with IBM's [GDPS](https://www.ibm.com/products/gdps) software and DS8000 series storage with HyperSwap -- to deliver 99.999999% (eight 9s) availability when running [Red Hat](https://www.redhat.com/en)'s be-spoke Kubernetes [OpenShift Container Platform](https://www.redhat.com/en/technologies/cloud-computing/openshift/container-platform). 
...
Moreover, the LinuxONE 4 Express can be used to set up [hybrid clouds](https://www.zdnet.com/article/red-hat-and-ibm-announce-a-hybrid-cloud-software-marketplace/) using Red Hat products. Tina Tarquinio, IBM Z and LinuxONE's VP of product management for IBM Z and LinuxONE, said: "IBM LinuxONE 4 Express is a chance for startups and small to medium-sized businesses to build an intentional hybrid cloud strategy from the ground up. IBM brings the power of the hybrid cloud and AI in the latest LinuxONE 4 system to a simple, easy-to-use format that fits in many data centers,"
...
It's not just IBM touting the benefits of the LinuxONE 4 Express. Steve McDowell, a [NAND Research](https://nand-research.com/) enterprise infrastructure industry analyst, observed: "It addresses a common challenge for growing businesses -- an [IT infrastructure that can adapt and evolve](https://www.forbes.com/sites/stevemcdowell/2024/02/07/ibm-brings-mainframe-to-the-masses-with-linuxone-4-express/?sh=5c7917633ba0) to meet their changing requirements. By offering a scalable solution, IBM is not just selling a product but providing a long-term value proposition."
...
[These open source tools help companies spot bias in advertising](https://www.zdnet.com/article/ibms-new-open-source-tools-help-companies-spot-bias-in-advertising/ "These open source tools help companies spot bias in advertising")

[IBM promises a 4,000 qubit quantum computer by 2025\. Here's what it means](https://www.zdnet.com/article/ibm-promises-a-4000-qubit-quantum-computer-by-2025-heres-what-it-means/ "IBM promises a 4,000 qubit quantum computer by 2025. Here's what it means")

[How the company is helping schools build up their ransomware defenses](https://www.zdnet.com/article/ibm-is-helping-these-schools-build-up-their-ransomware-defences/ "How the company is helping schools build up their ransomware defenses")

[IBM acquires Randori to streamline threat detection, bolster XDR offerings](https://www.zdnet.com/article/ibm-acquires-randori-to-streamline-threat-detection/ "IBM acquires Randori to streamline threat detection, bolster XDR offerings")
