...
categories:
  - tech
thumbnail: https://www.zdnet.com/a/img/resize/48ad0eea0bd314613a096ec100ed2667b4f8670f/2020/09/29/fa4b7083-dabf-4028-8aad-457ced94f8cb/twitter-logo-app.jpg?width=278&height=156&fit=crop&auto=webp
---

## Exploring Why Single Twitter Channels Aren't Enough - A Discussion Based on ZDNet Articles

[While on vacation](https://www.zdnet.com/article/on-grand-bahama-lifes-a-beach-the-internet-is-terrible-and-we-loved-it), I considered my response to [Elon Musk buying Twitter](https://www.zdnet.com/article/twitter-accepts-elon-musks-44-billion-buyout) and whether it would differ from the kneejerk analysis we already have. As a general rule, when I write about subjects related to technology, I try to take a different angle than what is already covered. 
...
* [The best Twitter alternatives](https://www.zdnet.com/article/best-twitter-alternatives/)
* [Ditching Twitter? How to get started with Mastodon](https://www.zdnet.com/article/how-to-get-started-with-mastodon/)
* [How to delete your Twitter account and protect your data](https://www.zdnet.com/article/how-to-delete-your-twitter-account/)
* [Mastodon isn't Twitter but it's glorious](https://www.zdnet.com/article/mastodon-isnt-twitter-but-its-glorious/)
* [FAQ: You've got Mastodon questions, I've got answers](https://www.zdnet.com/article/youve-got-mastodon-questions-weve-got-answers/)
...
I don't know how many Twitter-like services we need, whether it is a dozen, a hundred, or a thousand. Or tens of thousands. But is clear that there are many types of voices on Twitter, all of which are competing to be heard and are [subject to unknown algorithms that determine whose voices are surfaced and when](https://hbr.org/2019/11/when-algorithms-decide-whose-voice-will-be-heard#link=%7B%22role%22:%22standard%22,%22href%22:%22https://hbr.org/2019/11/when-algorithms-decide-whose-voice-will-be-heard%22,%22target%22:%22%5Fblank%22,%22absolute%22:%22%22,%22linkText%22:%22subject%20to%20unknown%20algorithms%20that%20determine%20whose%20voices%20are%20surfaced%20and%20when%22%7D). But suppose a community of voices is vocal enough or wants to amplify itself. In that case, it should be able to host its own microblogging platform if it is permitted in the country where it chooses to home itself and has the resources to do so. 

**Also: [Forget the algorithm: Here's what really makes Twitter unique](https://www.zdnet.com/article/forget-the-algorithm-heres-what-really-makes-twitter-unique/)**
...
Blockchain technologies and other [content provenance and authentication technologies, such as C2PA](https://c2pa.org/#link=%7B%22role%22:%22standard%22,%22href%22:%22https://c2pa.org/%22,%22target%22:%22%5Fblank%22,%22absolute%22:%22%22,%22linkText%22:%22content%20provenance%20and%20authentication%20technologies,%20such%20as%20C2PA%22%7D), could ensure transactional and referential integrity between systems and prove ownership of posted content. Various open authentication mechanisms, which have already been standardized on other platforms, such as Google ID, Microsoft ID, Facebook, and yes, Apple, Amazon, and Twitter, could be used for single sign-on. Accounts could be created and consolidated on these platforms, including allowing accounts from one system to participate in another via trust relationships. 
...
**Also: [No, Elon, Twitter will never be a platform for 'Free Speech'](https://www.zdnet.com/article/no-elon-twitter-will-never-be-a-platform-for-free-speech/)**
