---
title: Alibaba Cloud Ventures Into Blockchain-Powered Public Services as Partner in SG Government Cloud Project
...
categories:
  - tech
thumbnail: https://www.zdnet.com/topic/cloud/    https://www.zdnet.com/a/img/resize/a177a1d63f2bbb5b1753db283c89b82a6f628b50/2017/05/22/4dcbeeec-5455-423d-b180-5fb0b4228704/blockchain-in-english.jpg?width=170&height=96&fit=crop&auto=webp
---

## Alibaba Cloud Ventures Into Blockchain-Powered Public Services as Partner in SG Government Cloud Project
...
The Chinese cloud vendor believes [Web3 development](https://www.zdnet.com/article/what-is-web3-everything-you-need-to-know-about-the-decentralised-future-of-the-internet/) is driven by blockchain and immutable ledger technologies, with proponents such as the metaverse and social games that are built on top of public or private blockchains. 
...
Alibaba Cloud is hoping this will change in the near future, with [its Singapore](https://www.zdnet.com/article/alibaba-setting-up-cloud-datacentre-international-hq-in-singapore/) general manager Derek Wang expressing interest in collaborating with the government on the GCC. Adding more vendors to the mix was critical to offer users more choice, noted Wang.

He told ZDNET that Alibaba already was working with government agencies here on other initiatives, including projects that involved data and [artificial intelligence](https://www.zdnet.com/article/alibaba-sets-up-ai-research-facility-with-singapore-university/) (AI), but was unable to provide details due to confidentiality clauses. 

With growing interest in ESG (environment, social, governance), he said the Chinese cloud vendor also was helping organisations in Singapore with their net zero carbon emission strategies, such as tapping water cooling technology for [green data centres](https://www.zdnet.com/article/singapore-wants-only-data-centres-that-are-efficient/). This would further support the government's goal to drive sustainable developments and achieve net zero emissions. 
...
* [Singapore government pushes on with cloud migration](https://www.zdnet.com/article/singapore-government-pushes-on-with-cloud-migration/)
...
* [Alibaba sets up AI research facility with Singapore university](https://www.zdnet.com/article/alibaba-sets-up-ai-research-facility-with-singapore-university/)
* [Alibaba points to Singapore in response to cloud security concerns](https://www.zdnet.com/article/alibaba-points-to-singapore-in-response-to-cloud-security-concerns/)
* [Alibaba Cloud parks $1B in skills development, to build first Philippine data centre](https://www.zdnet.com/article/alibaba-cloud-parks-1b-in-skills-development-to-build-first-philippine-data-centre/)
* [Alibaba Cloud, Deloitte set up China facility to drive automotive applications](https://www.zdnet.com/article/alibaba-cloud-deloitte-set-up-china-facility-to-drive-automotive-applications/)
