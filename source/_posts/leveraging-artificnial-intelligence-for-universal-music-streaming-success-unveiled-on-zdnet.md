...
categories:
  - tech
thumbnail: https://www.zdnet.com/a/img/resize/0633a4c5edbe72602fde56bbe2c73f900ddf9a9e/2023/08/09/8bf2b1e8-043a-4682-a774-00860d38fa44/david-wide-3200x1900-name-newhouse.jpg?width=278&height=156&fit=crop&auto=webp
---

## Leveraging Artificnial Intelligence for Universal Music Streaming Success, Unveiled on ZDNet

![gewirtz-spotify](https://www.zdnet.com/a/img/resize/f944e158c95ae166a00fb394393a3e41a74142c2/2023/08/10/efaa9a45-4ace-4508-887c-c4cdae9a5205/gewirtz-spotify.jpg?auto=webp&width=1280)

My music is now on Spotify, Apple Music, Amazon Music, and all the rest. 

Screenshot by David Gewirtz/ZDNET

Some time ago, during a particularly dark time in my life, I found some solace in composing music that reflected my various moods. After that, the tracks sat, all 12 of them, waiting for -- I don't know -- _something_. 
...
But all that has changed. You may not realize it, but Americans still buy CDs and vinyl (about half "[like to purchase physical copies of their music](https://business.yougov.com/content/8352-an-insight-into-physical-music-buyers-understanding-the-american-market-for-cds-and-vinyl)"). That said, music streaming services have become popular and even more mainstream than physical album sales. 

Launching a new music album or EP no longer requires catching the eye of an A&R (artists and repertoire) executive at a record label. You can use a digital music distributor to push your music out onto [streaming services](https://www.zdnet.com/article/best-streaming-music-service/) without having to be considered marketable enough by some record executive, which really helps if your music doesn't fit neatly into a popular genre. 
...
I did dabble with, and then discard, the idea of using an AI to help master the music. Mastering is the process where an audio engineer takes your mix and _z_huzhes it up, making everything match, sound right, get the best balance, and sometimes even pull more from the music than the original composer was able to mix in originally. 
...
To help me choose which mastering service to try, I watched [these folks](https://youtu.be/ERtPyJLgdsI) compare a number of automated mastering tools. They determined that [LANDR](https://www.landr.com/pricing/) was the best of the AI tools, so that's the one I tried. 

**Also: [How to improve the quality of Spotify streaming audio](https://www.zdnet.com/home-and-office/home-entertainment/how-to-improve-the-quality-of-spotify-streaming-audio/)**

I'm certainly not a sound engineer, and while anyone's music can probably benefit from the wisdom and skills of a deeply experienced human sound engineer, I write about AI. So I plunked down $40 for [LANDR's premium mastering plan](https://www.landr.com/pricing/) and gave it a shot. 
...
But today, it's better to release music in what's called a [waterfall release strategy](https://blog.groover.co/en/tips/waterfall-strategy-release-singles/). The idea is you do successive releases of singles, in order to get more play on social media and on digital platforms. 
...
**Also:** [**The best AI art generators: DALL-E 2 and fun alternatives to try**](https://www.zdnet.com/article/best-ai-art-generator/)
...
**Also: [ChatGPT's Custom Instructions feature is now available for everyone](https://www.zdnet.com/article/chatgpts-custom-instructions-feature-is-now-available-for-everyone/)**
...
If you plan to promote your music, you're going to need a bio. Now, as it turns out, I have a bunch of bios. I have [my very pompous primary professional bio](https://davidgewirtz.com/bio/), and I've also had to create bios focused on certain areas of my work for various clients and speaking gigs over the years. But, without a doubt, none of them was suitable as a musician bio. 

**Also: [7 advanced ChatGPT prompt-writing tips you need to know](https://www.zdnet.com/article/7-advanced-chatgpt-prompt-writing-tips-you-need-to-know/)**
...
You can see the result on the House of the Head website, on [the bio page](https://houseofthehead.com/bio/). Since I used AI for nearly all the graphics on my music website, it's probably fair to point you there now. 
...
**Also: [ChatGPT Plus can mine your corporate data for powerful insights. Here's how](https://www.zdnet.com/article/chatgpt-plus-can-mine-your-corporate-data-for-powerful-insights-heres-how/)**
...
**Also: [How (and why) to subscribe to ChatGPT Plus](https://www.zdnet.com/article/how-to-subscribe-to-chatgpt-plus-and-why/)**
...
But I loaded the image into Photoshop, added more canvas space on either side of the original images, and [Photoshop Generative Fill](https://www.zdnet.com/article/adobe-generative-expand-adds-to-photoshops-ai-arsenal/) gave me a much wider image. 

**Also: [How to use Photoshop's Generative Fill AI tool to easily transform your boring photos](https://www.zdnet.com/article/how-to-use-photoshops-generative-fill-ai-tool-to-easily-transform-your-boring-photos/)**
...
The image above was fine, except it wasn't my face. To fix that, I used [Insight FaceSwap](https://insightface.ai/). I uploaded another image of me that showed my face pretty well: 
...
As you can see, it's not really my face. And that hair. That was most definitely _not_ my hair. 
...
**Also:** [**These 3 AI tools made my two-minute how-to video way more fun and engaging**](https://www.zdnet.com/article/how-i-used-these-three-ai-tools-to-help-make-a-two-minute-video/)
...
The key to all of this is a category of cloud service called "music distribution services." For a shockingly nominal fee (as little as $10), you can get a track uploaded to all of the major services. I paid $49 to [CD Baby](https://cdbaby.com/) to distribute my EP, and they did just that. It's now on Spotify, Apple Music, Amazon Music, and about 150 other streaming platforms. 

**Also: [I used ChatGPT to rewrite my text in the style of Shakespeare, C3PO, and Harry Potter](https://www.zdnet.com/article/i-used-chatgpt-to-rewrite-my-text-in-the-style-of-shakespeare-c3po-and-harry-potter/)**
...
To become a verified artist on Spotify, for example, it was up to me to properly fill out all the forms, sign up for the artist account, and curate the music. I also went to [Copyright.gov](http://Copyright.gov) to register my copyrights online, and signed up with a performing rights organization (PRO) so royalties on radio play will be collected. There is still a lot of product management work to getting music out, but if you're willing to do the work, you can get distribution.
...
**Also:** [**Apple Music finally adds personalized recommendations, while Spotify expands AI DJ**](https://www.zdnet.com/article/apple-music-finally-adds-personalized-recommendations-while-spotify-expands-ai-dj/)
...
And with that, the first wave of this project is done. If you want to listen to any of these tracks, point your browser to [House of the Head](https://houseofthehead.com) and click directly into the music service of your choice. 

**Also: [Everything you need to start a podcast: The best microphones, headphones, and software](https://www.zdnet.com/home-and-office/home-entertainment/everything-you-need-to-start-a-podcast/)**
...
**_Disclaimer:_** _Using AI-generated images could lead to copyright violations, so people should be cautious if they're using the images for commercial purposes._ 
...
**_Disclaimer:_** _You should consider the legal consequences (e.g. copyright) of using AI-generated images before implementing them into your work._ 
